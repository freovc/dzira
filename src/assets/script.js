...
$(".btn--delete").on('click', function() {
  ...
  $(".box--delete").after("<div class='delete-background background-after-click'></div>");
})
...
$(".btn--edit").on('click', function() {
  ...
  $(".box--edit").after("<div class='edit-background background-after-click'></div>");
})
...
$(".btn--password").on('click', function() {
  ...
  $(".box--password").after("<div class='password-background background-after-click'></div>");
})
